...
public class SortItem {
 /*   private static SortItem sortItem;
    ...
    public ArrayList<Item> sortBy(String sortBy) {
        if (SearchAndFilterController.getInstance().getCurrentViewableItems().isEmpty()) return null;
        ArrayList<Item> newViewable = new ArrayList<>();
        for (Item item : SearchAndFilterController.getInstance().getCurrentViewableItems()) {
    ...
    public ArrayList<Item> disabeSort() {
        return SearchAndFilterController.getInstance().getCurrentViewableItems();
    }
