...
public class LoadGson {
    ...
    private static void loadSale() throws IOException {
        Gson gson=new GsonBuilder().setPrettyPrinting().create();
    ...
    private static void loadItem() throws IOException {
        Gson gson=new GsonBuilder().setPrettyPrinting().create();
    ...
    private static void loadDiscountCode() throws IOException {
        Gson gson=new GsonBuilder().setPrettyPrinting().create();
    ...
    private static void loadRequest() throws IOException {
        Gson gson=new GsonBuilder().setPrettyPrinting().create();
    ...
    private static void loadMainCategory() throws IOException {
        Gson gson=new GsonBuilder().setPrettyPrinting().create();
    ...
    public static void loadFromDataBase() throws IOException {
